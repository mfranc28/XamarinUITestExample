...
namespace BddWithXamarinUITest
{
	public static class AppInitializer
	{
		...
		static void ResetEmulator()
		{
			...
			{
				var eraseProcess = Process.Start ("/Users/Michelangelo/Library/Developer/Xamarin/android-sdk-macosx/platform-tools/adb", "shell pm uninstall com.xamarin.samples.taskydroid");
